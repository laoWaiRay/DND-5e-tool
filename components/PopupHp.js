              ...
              >
                ...
                <div className='flex'>
                  <div className='w-full flex flex-col space-y-2'>
                    ...
                    <form className='text-sm flex items-center justify-center space-x-3'>
                      ...
                      />
                      <button 
                        className='bg-transparent border border-gray-400 text-sm p-[5px] px-2 rounded text-gray-100'
                ...
                >
                  <div 
                    ...
                    text-gray-200 p-2.5 rounded-md border-gray-600 border space-x-1'
                  >
